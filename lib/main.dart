...
void main() async{
  ...
  log_handler?.i(
      'directive: ${config_data.directive}\n'
          ...
          'generate_ai_response_suffix: ${config_data.generate_ai_response_suffix}\n'
          'sign_up_suffix: ${config_data.sign_up_suffix}\n'
          'log_out_suffix: ${config_data.log_in_suffix}\n'
          'log_out_suffix: ${config_data.log_out_suffix}\n'
          'refresh_token_suffix: ${config_data.refresh_token_suffix}\n'
          'reset_password_suffix: ${config_data.reset_password_suffix}\n'
          'complete_profile_suffix: ${config_data.complete_profile_suffix}\n'
          'check_user_exists_suffix: ${config_data.check_user_exists_suffix}\n'
          'user_preferences_suffix: ${config_data.user_preferences_suffix}\n'
